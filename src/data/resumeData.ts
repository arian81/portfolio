...
export const experience = [
  ...
  },
  {
    ...
    location: "Toronto, ON",
    technologies:
      "Python, VertexAI(GCP), LLM, Next.js, React, FastAPI, Big Query, PostgreSQL, Cloud Run",
    achievements: [
  ...
  },
  {
    ...
    technologies:
      "Next.js, TRPC, Prisma, Netlify, Tailwind, NextAuth.js, Typeform, PostgreSQL",
    achievements: [
...
export const hackathons = [
  {
    ...
    technologies:
      "Next.js, TypeScript, React, PostgreSQL, Redis, Drizzle ORM, GitHub API",
    achievements: [
...
export const skills = [
  {
    category: "Languages",
    items:
      "Python, Web Development (JavaScript, Typescript, HTML, CSS), Java, C++, C, Rust, Bash, Haskell",
  },
  {
    category: "Frameworks",
  ...
  },
  {
    category: "Tools",
    items:
      "Linux, Git, Cloud Services (Google Cloud Platform, AWS), Relational Databases (SQL, PostgreSQL)",
  },
  {
    category: "Design",
