  ...
  return (
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path
          fill="#000"
          d="M92.2 226.8c7.4 15.8 18.9 29.2 32.6 39.8.5.4 0 1.2-.6.9-12.2-5.8-22.5-15.7-28.6-27.7-2-4-3.7-8.3-4.3-12.8-.2-.5.6-.7.9-.2Zm117.1 3.3c.3 16.7-6.5 33.8-19.5 44.6-.3.3-.7.2-1-.1-.3-.3-.2-.7.1-1 2.9-2.8 5.8-5.7 8-9.1 4.6-6.6 7.4-14.4 8.7-22.3.6-3.9 1-8.1.7-12-.1-1.9 2.9-2.1 3-.1Zm-58.9 39.7c-2.3 8.1-4.2 16.9-3.1 25.3.3 1.9-2.6 2.4-3 .4-.5-4.6.1-9.1.9-13.5.9-4.4 2-8.6 3.5-12.8.4-1 2.1-.5 1.7.6Zm31.8-1.5c3.3 7.1 5.6 14.5 7.4 22 .2.8-.3 1.6-1.1 1.8-.8.2-1.6-.3-1.8-1.1-1-5.6-2.3-11.2-4.1-16.7-.6-1.8-1.2-3.6-1.9-5.4-.4-.9 1-1.6 1.5-.6Z"
        />
        <path
          fill="#000"
          d="M74.8 218.2c3.7 20.2 17.9 37.3 35 48.2 5.8 3.7 12 6.9 18.4 9.5.4.2.6.6.4 1-.1.4-.6.6-.9.4-6.6-2.4-13-5.4-19-9-12.2-7.2-22.9-17.2-30.1-29.4-3.7-6.3-6.6-12.9-8-20.1-.2-1.2.6-2.3 1.8-2.5 1.1-.3 2.3.6 2.4 1.9Zm69.6 79.1c-2.8-.3-4.8-2.9-4.2-5.7l1.1-5.3c.4-2.1 2.4-3.6 4.5-3.3 2.1.2 3.8 2 3.8 4.2v5.4c.1 2.8-2.3 5-5.2 4.7Zm46.1-3.7c-2.7 1-5.6-.6-6.3-3.4l-1.3-5.3c-.5-2.1.6-4.2 2.7-5 2-.7 4.3.2 5.2 2.1l2.4 4.9c1.2 2.7 0 5.8-2.7 6.7Z"
        />
        <path
          stroke="#000"
          strokeLinecap="round"
        ...
        <path
          fill="#000"
          d="M106.1 214.6c-1.4-4-2-8.1-1.7-12.3 0-.4.3-.6.7-.6.3 0 .6.3.6.6.3 3.8 1.4 7.7 3.2 11 .9 2-2.1 3.3-2.8 1.3Zm67.6 5.3c-2.8-6.3-9.7-9.5-15.8-11.7-3.8-1.2-8-2.1-12-2.7-9.7-1.5-23.4-3.8-33.1-4.8-.1 0-.1-.2 0-.2 2.8-.3 5.6-.3 8.4-.3 8.4.2 16.8 1.1 25.1 2.4 8.3 1.3 17.2 3.8 23.5 9.8 2 2.1 3.8 4.5 4.3 7.4.1.3-.3.4-.4.1Z"
        />
      </svg>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none">
        <title>Profile avatar</title>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        <path
          fill="#000"
          d="M174.7 157.5s-9.4 5.9-20 5.8c-10.6-.1-11.9-8.4-12-12.9 0 0 1.4 6.5 7.8 8.9 6.3 2.4 24.2-1.8 24.2-1.8Zm30.199-1.1s2.3 2.8 5.4 4.8c2.1 1.4 4.9-.1 4.9-2.6 0 0-5.8.3-10.3-2.2Z"
        />
        <path
          fill="#000"
          d="M178.2 130.8c-5.4-.5-19-1.6-24.2-2.1l-4-.3c-3.3-.2-5.9 2.6-6.5 5.8-.2 1-.2 2.7-.2 3.7v4.1c0 2.5-.1 5.1.8 7.5 1.6 5.6 6.7 10.1 12.7 9.4.6-.1 4.3-.5 5-.6l8.1-.9c2.6-.2 5-.9 7.3-2.3 3.2-1.9 6.3-4.8 6.1-8.9l.2-4c.2-5 1.6-10.9-5.3-11.4Zm.3-3.3c4.7.4 7.9 5.3 7.6 9.8 0 .6-.2 4.4-.3 5.1 0 .8-.2 4.4-.3 5.1-.5 6.8-8.1 11.6-14.3 12.5-3.2.4-9.9 1.3-13.1 1.7-.8.1-1.9.2-2.7.3-.4 0-1.3-.1-1.7-.1-8.5-1.1-13.9-9.8-13.7-17.9v-6.1c0-.7 0-2.5.1-3.2.3-3.5 2.2-6.9 5.4-8.8 1.4-.8 3.1-1.2 4.8-1.1l4.1.4c5 .6 18.8 1.9 24.1 2.3Zm23.2 1.6c2.2-.3 13-1.5 15-1.7.5 0 1.8-.2 2.2-.2 4.3-.6 6.3 4.1 6.7 7.6.2 3.1 0 6.1.1 9.1 0 2.1-.2 4.2-.7 6.2-1.3 5.4-5.1 11.1-11.4 9.3-1.5-.3-4.5-.7-5.9-1l-1.5-.3c-2.9-.5-5.3-2.5-6.9-4.7-3-3.5-2.4-8.2-2.7-12.4-.4-4.2-.3-10.7 5.1-11.9Zm.4 2.9c-3.1 1.4-2.3 6.1-2.3 8.9l.2 6c.1 3.8 3.1 7.6 6.7 8.6.9.2 3.4.7 4.4.9l2.9.6c7.2 2.3 10-7.7 9.9-13.2-.3-4.6 1.1-10.1-2.2-13.8-.8-.8-1.6-1-2.5-.8-.5.1-1.8.3-2.2.4-2 .4-12.8 2.1-14.9 2.4Z"
        />
        <path
          fill="#000"
          d="M141.6 138.4c-.8 1.8-1.5 1.6-2.9 1.6l-2.9-.1c-3.7-.2-7.8-.5-11.5-1-2-.3-4.1-.6-6.1-1.1-.8-.2-1.3-1-1.1-1.8.2-.7.8-1.2 1.5-1.1l5.8.3 5.8.2c1.9.1 6.8.2 8.7.3 1 0 1.9.1 2.9-.2.4-.1.8.1.9.5.1.2 0 .3 0 .5l-1.1 1.9Zm42.6-2.1c3.6-2 13.1-4.8 14.9.6.8 1.4-1.3 2.7-2.2 1.3 0 .2-.5 0-.7 0-3.8-.3-7.7.3-11.5.6-1.6.2-1.9-1.9-.5-2.5Z"
        />
      </svg>
    </svg>
  );
